...
**NOTE:** If you are building a React application, you can use our React voice embed SDK instead of this one. [Documentation can be found here](https://github.com/hbmartin/hume-react-sdk/blob/main/packages/embed-react).
...
Configuration options for the embedded voice include all props that are accepted by the VoiceProvider in the [@humeai/voice-react package](https://github.com/hbmartin/hume-react-sdk/blob/main/packages/react).
