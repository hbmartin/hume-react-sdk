...
hero:
  name: Hume Voice SDK
  text: Build expressive voice experiences
  tagline: Guides and generated API reference for Hume's JavaScript and React voice packages.
  actions:
    - theme: brand
      text: Get started
...
This first iteration follows the repository's `main` branch. It may describe
changes that have not reached every npm package yet.
:::
